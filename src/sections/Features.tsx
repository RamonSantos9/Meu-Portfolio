...
import avatar1 from "@/assets/images/avatar-user.png";
    ...
    <section id="Features" className="py-24">
      <div className="container">
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-poppins text-center font-medium mt-10">
          Com Design Personalizado e Tecnologia de Ponta para{" "}
          <span className="text-lime-400">Potencializar Seu Negócio.</span>
        </h2>
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
          <FeatureCard
            title="✨ Progresso ao Vivo"
            description="Acompanhe cada etapa do desenvolvimento do seu site em tempo real. Damos vida às suas ideias enquanto ajustamos cada detalhe com perfeição."
          ...
          <FeatureCard
            title="🚀 Inovação Surpreendente"
            description="Usamos tecnologia de ponta para criar soluções modernas e impactantes que superam expectativas."
            className="md:col-span-2 lg:col-span-1 group"
          >
            <div className="aspect-video flex items-center justify-center">
          ...
          <FeatureCard
            ...
            description="Transformamos sua visão em realidade com designs exclusivos e feitos sob medida para atender às suas necessidades."
